...
const AddGeospatialLayerModalV2 = ({ onLayerAdded, trigger, open, onOpenChange }) => {
  const [isOpen, setIsOpen] = useState(false);
  
  // Utiliser open/onOpenChange si fournis, sinon utiliser l'état interne
  ...
  const handleFileSelect = useCallback(
    async (file) => {
      ...
      try {
        ...
        // Prévisualisation géospatiale indisponible, utilisation du mock
        setTimeout(() => {
          setPreviewData(buildMockPreview());
        }, 1000);
      }
