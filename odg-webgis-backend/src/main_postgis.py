...
from src.routes.webgis_postgis import register_webgis_routes
import os
import logging
...
def create_app():
    ...
    def migrate_data_command():
        ...
        from src.migrate_to_postgis import migrate_sqlite_to_postgis, verify_migration
    ...
    def create_sample_data_command():
        ...
        from src.migrate_to_postgis import create_sample_data
