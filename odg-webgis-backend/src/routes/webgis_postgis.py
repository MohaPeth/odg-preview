...
from geoalchemy2.functions import ST_GeomFromText, ST_Distance, ST_DWithin
    ...
    try:
        ...
        for substance in Substance.query.all():
            ...
            substance_stats.append({
                ...
                'estimatedValue': float(total_value.total) if total_value.total else 0,
                'marketPrice': substance.market_price_eur
            })
        ...
        return jsonify({
            ...
            'data': {
                'overview': {
                    ...
                    'affectedPopulation': int(total_affected_population.total) if total_affected_population.total else 0
                },
